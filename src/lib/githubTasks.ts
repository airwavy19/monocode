...
import { formatRelativeTime as formatRelativeTimeImpl } from "./relativeTime";

export { formatRelativeTimeShort } from "./relativeTime";
...
export function formatRelativeTime(
  ...
  return formatRelativeTimeImpl(value, now, locale);
}
